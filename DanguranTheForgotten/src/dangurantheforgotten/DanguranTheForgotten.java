...
public class DanguranTheForgotten {
    ...
    public static void setCurrentGame(Game currentGame) {
        DanguranTheForgotten.currentGame = currentGame;
    }
    ...
    public static void setPlayerCharacter(PlayerCharacter playerCharacter) {
        DanguranTheForgotten.playerCharacter = playerCharacter;
    }
